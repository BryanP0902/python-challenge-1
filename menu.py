...
while continue_ordering:
        ...
        if menu_category.isdigit():
            ...
            if int(menu_category) in menu_items.keys():
                ...
                if menu_selection.isdigit():
                    ...
                    quantity = input("How many would you like? If you do not enter a valid number, it will default to 1: ")
    ...
    if keep_ordering != 'Y':
        ...
        for item in order_list:
            ...
            order += f"Item: {item['Item name']}\n"
            order += f"Price: ${item['Price']:.2f}\n"
            order += f"Quantity: {item['Quantity']}\n\n"
...
# 8. Calculate the number of spaces for formatted printing
    ...
    price_spaces = 6 - len(str(f"{price:.2f}"))
    quantity_spaces = 8 - len(str(quantity))

# 9. Create space strings
    name_padding = " " * name_spaces
    price_padding = " " * price_spaces
    quantity_padding = " " * quantity_spaces

    # 10. Print the item name, price, and quantity
    print(f"{item_name}{name_padding}| ${price:.2f}{price_padding}| {quantity}{quantity_padding}")
